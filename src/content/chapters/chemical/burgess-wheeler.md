...
| ΔHc | **연소열** · kcal/mol · 몰당 발열량 |
| 1,100 | **법칙 상수** · vol%·kcal/mol · 약(≈) 값 |
| 물리적 의미 | 폭발하한계 농도의 혼합기가 내는 **단위부피당 발열량**은 **연료 종류와 무관하게 거의 일정**(연소가 자립하는 최소 에너지 밀도) |
| Burgess-Wheeler 법칙 | **Jones식(양론 기반)** · **Burgess-Wheeler(발열량 기반)는** **하한계를 추정하는 두 갈래 경험식**으로 세트 정리 |
