...
|---|---|
| LFL·UFL | **$LFL = 0.55 \times C_{st},\quad UFL = 3.5 \times C_{st}$** |
| nO2 | **$n_{O_2} = 6.5 \Rightarrow C_{st} = \frac{100}{1+4.773 \times 6.5} \approx 3.1 \Rightarrow LFL = 0.55 \times 3.1 \approx 1.7\,\text{vol\%}$** |
| LFL(L) | **폭발하한계** · **0.55 Cst** · vol% |
| UFL(U) | **폭발상한계** · **3.5 Cst** · vol% |
