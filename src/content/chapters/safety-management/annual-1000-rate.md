...
기출에서는 연간 근로시간을 2,400시간으로 두어 도수율과 연천인율 사이를 환산하는 유형이 반복된다. 2020년 6월 시험 4번의 도수율 10은 연천인율 24로, 2019년 4월 시험 1번의 연천인율 45는 도수율 18.75로 계산되는 구조다. 2018년 8월 시험 17번처럼 근로자 수와 도수율로 연간 재해건수를 묻는 문제도 같은 환산 관계를 확인한다.
...
> ⚠️ **함정 주의**: 연천인율의 분모는 평균 근로자 수다. 총근로시간을 직접 분모로 사용하지 않으며, 도수율·강도율·사망만인율의 기준과 혼동하지 않는다.
