...
>
> **최초 작성일**: 2026-07-14 / **최종 갱신일**: 2026-08-13 / **작성자**: Claude·ChatGPT·Codex / **버전**: v1.17
...
- **최신 동적 상태**: 문서 맨 아래의 `전 공개 챕터 시험 포인트 전수 개선 production 게이트 완료` 절을 우선한다.
...
다음 작업은 Owner 우선순위에 따라 산업안전기사 미연결 이미지의 관계 검토, 컴활 2급 추가 회차 내재화, 기출 이용 권리 결정 또는 수익화·분석 상태 확인 중 하나를 별도 승인 범위로 진행한다.
